...
import com.example.cityguild.adapter.QuestAdapter;
...
public class QuesttypeActivity extends BaseActivity {
	private ListView lv;
	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				break;
			case 1:
				Toast.makeText(QuesttypeActivity.this, (String) msg.obj,
						Toast.LENGTH_SHORT).show();
				break;
			case 2: // 网络有问题
				Toast.makeText(QuesttypeActivity.this, "没有网络连接!",
						Toast.LENGTH_SHORT).show();
				break;
			case 3:
	...
	private void initView() {
		...
		adapter = new QuestAdapter(this, this, myList);
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				try {
					...
					if (code == -2) {
						...
						Toast.makeText(QuesttypeActivity.this,
